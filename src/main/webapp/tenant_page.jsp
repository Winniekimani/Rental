                ...
                <div class="panel-body">
                    ...
                    <div id="panelBodyItemlist" class="switchgroup">
                        <table class="table table-bordered table-hover">
                            ...
                            <c:forEach items="${tenantBean.getPatientListByEmail(email)}" var="patient">
                                <tr>                            
                                    <td>
                                        ${tenant.id}
                                    </td>
                    ...
                    <c:forEach items="${tenantBean.getTenantListByEmail(email)}" var="tenant">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="number" class="form-control" name="id"
                                                            placeholder="Patient ID" value="${tenant.id}" readonly="readonly">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" name="name"
                                                            value="${tenant.name}" placeholder="Name">
                                                    </div>
                                                </div>
